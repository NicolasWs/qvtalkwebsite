      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            QVTalk represents the next generation of personalized well-being
            support, leveraging advanced conversational AI to provide 24/7
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <Card className="p-8 bg-white/70 backdrop-blur-sm border-slate-200/50 shadow-lg">
            ...
            <p className="text-slate-600 mb-4">
              Our advanced natural language processing enables meaningful,
              empathetic conversations that adapt to each user's unique
          ...
          <Card className="p-8 bg-white/70 backdrop-blur-sm border-slate-200/50 shadow-lg">
            ...
            <p className="text-slate-600 mb-4">
              Each interaction is tailored based on user history, preferences,
              and current emotional state, providing increasingly relevant and
              effective support over time.
            </p>
            <Badge
              variant="outline"
          ...
          <Card className="p-8 bg-white/70 backdrop-blur-sm border-slate-200/50 shadow-lg">
            ...
            <p className="text-slate-600 mb-4">
              Built with privacy at its core, QVTalk ensures all conversations
              remain confidential while providing the therapeutic benefits of
              AI-guided support.
            </p>
            <Badge
              variant="outline"
          ...
          <Card className="p-8 bg-white/70 backdrop-blur-sm border-slate-200/50 shadow-lg">
            ...
            <p className="text-slate-600 mb-4">
              Connect with like-minded individuals in moderated support groups
              while maintaining the privacy and personalization of individual AI
              conversations.
            </p>
            <Badge
              variant="outline"
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-slate-700">
                QVTalk is uniquely positioned at the intersection of{" "}
                <strong>Visionaries and Niche Players</strong> in the well-being
                solutions magic quadrant, representing breakthrough innovation
                with focused market execution and rapid growth potential.
              </p>
            </div>
          </div>
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
            ...
            personalized AI conversations for mental health and well-being
            support.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:info@qvtalk.fr?subject=Start My QVTalk Journey&body=Hello,%0A%0AI'm interested in starting my journey with QVTalk. Please provide me with more information about getting started.%0A%0AThank you!">
              <Button
                size="lg"
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 w-full"
              >
                Start Your Journey
              </Button>
            </a>
            <a href="mailto:info@qvtalk.fr?subject=QVTalk Demo Request&body=Hello,%0A%0AI would like to request a demo of QVTalk. Please let me know when we can schedule a demonstration.%0A%0AThank you!">
              <Button
                size="lg"
                variant="outline"
                className="border-slate-300 hover:bg-slate-50 px-8 w-full"
              >
                Request Demo
              </Button>
            </a>
